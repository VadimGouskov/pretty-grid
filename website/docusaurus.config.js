...
const config = {
  ...
  organizationName: 'Vadim Gouskoc', // Usually your GitHub org/user name.
  projectName: 'pretty-grid', // Usually your repo name.
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        //   },
        // ],
        copyright: `Copyright © ${new Date().getFullYear()} Vadim Gouskov, this website is built with Docusaurus.`,
      },
      prism: {
